                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                        ...
                        <ul id="nav-list" class="navbar-nav justify-content-center navItem">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link item mx-1" href="#features">Featues</a>
                            </li>
                            <li class="nav-item ">
		...
		<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
		  ...
		  <div class="carousel-inner">
			...
			<div class="carousel-item">
			  <h2>10000+ Books available</h2>
			</div>
			<div class="carousel-item">
			  <h2>1000+ Users Registered</h2>
			</div>
		  </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 m-auto text-center col-sm-12
                            ...
                            <div class="banner-content content-padding">
                                ...
                                <a href="./html/catelogue.html" class="btn btn-white
            ...
            <div class="row d-flex justify-content-center mt-0 pb-5 feature-div">
                ...
                <div class="col-lg-3 col-md-5 col-sm-10 feature-box">
                    <a href="./html/request.html">
                        ...
                        <p>Request to add new books to the inventory</p>
                    </a>
                </div>

                <div class="col-lg-3 col-md-5 col-sm-10 feature-box">
                    <a href="./html/adminDB.html">
                ...
                <div class="col-lg-3 col-md-5 col-sm-10 feature-box">
                    <a href="./html/issuehistory.html">
                        <i class="icon fa fa-bar-chart fa-2x"></i>
                        <h3>Check Statistics</h3>
                        <p>Check your Issue history details</p>
                    </a>
                </div>

                <div class="col-lg-3 col-md-5 col-sm-10 feature-box">
                    <a href="./html/userDB.html">
